  ...
  try {
    ...
    function loadComponentRelay() {
      ...
      cr = new ComponentRelay({
        ...
        onReady: e => {
          ...
          toggleButton = document.getElementById('btn-edit')
          loadEditor()
        },
    ...
    function onReceivedNote(note) {
      ...
      if (initialLoad) {
        ...
        console.log(mode)
        if (mode === 'split') {
          toggleButton.setAttribute('class', 'btn-submit')
      ...
      if (container && editor) {
        if (note.content.text !== lastValue) {
          editor.value = workingNote.content.text
          runHtml(workingNote.content.text)
        }
      }
    }
    ...
    function loadEditor() {
      ...
      toggleButton.addEventListener('click', e => {
        if (toggleButton.getAttribute('class') === 'btn-submit') {
          editor.style.display = 'none'
          toggleButton.setAttribute('class', '')
          saveMetadata('preview')
        } else {
          editor.style.display = 'block'
          toggleButton.setAttribute('class', 'btn-submit')
          saveMetadata('split')
